    ...
    internal partial class TrayIcon
    {
        internal static class Template
        {
            ...
            internal static void Checkin()
            {
                ...
                var templateCheckin = new TemplateModels.Template.CheckinPendencia(pendenciaId);
            ...
            {
                var templateRetornoDeIncidente = new TemplateModels.Template.CheckinRetornoDeIncidente(pendenciaId);
